// Code generated by tools/tablegen from pdf-inspector v1.14.2 src/glyph_names.rs. DO NOT EDIT.

package glyphs

// glyphTable is the Adobe Glyph List (and related names) extracted from the
// upstream build_glyph_to_unicode_map() body (4528 entries).
...
// glyphOverrides are local overrides for non-standard glyph names seen in
// PDFs, applied on top of glyphTable by the GLYPH_TO_UNICODE LazyLock (4 entries).
