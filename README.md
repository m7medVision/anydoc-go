...
| --- | --- | --- |
| `unsupported` | Format not recognised, CSV without a name, or `ToDocument` on PDF | |
...
- Test fixtures under `testdata/` are copied from the anydoc repository. See `testdata/README.md`.
